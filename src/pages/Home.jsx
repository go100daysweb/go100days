    ...
    for (let i = 0; i < servicesList.length; i++) {
      ...
      cards.push(
        <Link
          key={i}
          to="/services"
          className="group flex flex-col bg-white dark:bg-black border border-[#e7e7e7] dark:border-transparent rounded-[2rem] p-6 hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 min-h-[380px]"
        >
          ...
          <div className="flex flex-col flex-grow mt-6 justify-between">
            ...
            <span className="text-xs font-bold tracking-widest uppercase mt-6 opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1.5 text-black dark:text-white">
  ...
  return (
    <div className="flex flex-col w-full">
      <section className="relative min-h-screen flex items-center w-full overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full flex flex-col items-start mt-24 md:mt-0">
          <motion.div
          ...
          >
            ...
            <div className="mt-14 pt-10 border-t border-neutral-200 dark:border-neutral-800 grid grid-cols-2 md:grid-cols-4 gap-8 w-full max-w-2xl">
              {[
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 w-full relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            {
              number: '01',
              title: 'Full P&L Ownership',
              desc: 'We take accountability for your revenue, margins, and profitability — not just impressions and clicks.',
            },
            {
              number: '02',
              title: 'Speed to Market',
              desc: 'From diagnostic to live execution in days. No long strategy decks. Just action, iteration, and results.',
            },
            {
              number: '03',
              title: 'Data-Driven at Every Step',
              desc: 'Every decision is backed by cohort data, SKU-level P&L, and real-time channel analytics.',
            },
          ].map((item) => (
            <motion.div
              key={item.number}
              ...
              className="p-8 border border-neutral-200 dark:border-neutral-800 rounded-2xl bg-white dark:bg-neutral-950 hover:border-[#14b5bc] dark:hover:border-[#14b5bc] transition-colors duration-300 group"
            >
              <p className="text-4xl font-black text-neutral-400 dark:text-neutral-600 mb-6 tracking-tight group-hover:text-[#14b5bc] transition-colors">
                {item.number}
              </p>
